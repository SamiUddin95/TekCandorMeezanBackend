    ...
    public class ChequeDepositImportService : IChequeDepositImportService
    {
        ...
        private async Task<ChequedepositInfo> ParseChequeDepositDataAsync(string[] fields, Random random, string callbackLimit)
        {
            ...
            var chequeDeposit = new ChequedepositInfo
            {
                ...
                IQATag = fields[13],
                DocumentSkew = fields[14],
                Piggyback = fields[15],
                ImageToolight = fields[16],
                HorizontalStreaks = fields[17],
                BelowMinimumCompressedImageSize = fields[18],
                AboveMaximumCompressedImageSize = fields[19],
                UndersizeImage = fields[20],
                FoldedorTornDocumentCorners = fields[21],
                FoldedOrTornDocumentEdges = fields[22],
                FramingError = fields[23],
                OversizeImage = fields[24],
                ImageTooDark = fields[25],
                FrontRearDimensionMismatch = fields[26],
                CarbonStrip = fields[27],
                OutOfFocus = fields[28],
                QRCodeMatch = fields[29],
                UV = fields[30],
                MICRPresent = fields[31],
                StandardCheque = fields[32],
                InstrumentDuplicate = fields[33],
                AverageChequeAmount = Convert.ToDecimal(fields[34]),
                TotalChequesCount = fields[35],
                TotalChequesReturnCount = fields[36],
                CaptureAtNIFT_Branch = fields[37],
                DeferredCheque = fields[38],
                FraudChequeHistory = fields[39],
