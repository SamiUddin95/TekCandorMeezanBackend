...
namespace TekCandor.Repository.Implementations
{
    public class ChequeDepositRepository : IChequeDepositRepository
    {
        ...
        public async Task<(IEnumerable<ChequeDepositListResponseDTO> Data, int TotalCount)> GetCallbackListAsync(
           ChequeDepositListRequestDTO request,
           long userId,
           string branchOrHub,
           string? hubIds,
        ...
        public async Task<(IEnumerable<ChequeDepositListResponseDTO> Data, int TotalCount)> GetReturnListAsync(
           ChequeDepositListRequestDTO request,
           long userId,
           string branchOrHub,
           string? hubIds,
           ...
           CancellationToken cancellationToken = default)
        {
            ...
            where.Append(" AND ChequeDepositInformation.status IN ('R')");
            where.Append(" AND ChequeDepositInformation.Date = CAST(CAST(GETDATE() AS date) AS datetime)");
            where.Append(" AND ChequeDepositInformation.IsDeleted = 0");
        ...
        public async Task<(IEnumerable<ChequeDepositListResponseDTO> Data, int TotalCount)> GetBranchReturnListAsync(
          ChequeDepositListRequestDTO request,
          long userId,
          string branchOrHub,
          string? hubIds,
          ...
          CancellationToken cancellationToken = default)
        {
            ...
            where.Append(" AND ChequeDepositInformation.status IN ('RE') AND Remarks is null");
            where.Append(" AND ChequeDepositInformation.Date = CAST(CAST(GETDATE() AS date) AS datetime)");
            where.Append(" AND ChequeDepositInformation.IsDeleted = 0");
        ...
        public async Task<(IEnumerable<ChequeDepositListResponseDTO> Data, int TotalCount)> GetApprovedListAsync(
          ChequeDepositListRequestDTO request,
          long userId,
          string branchOrHub,
          string? hubIds,
          ...
          CancellationToken cancellationToken = default)
        {
            ...
            where.Append(" AND ChequeDepositInformation.status IN ('A','MA')");
            where.Append(" AND ChequeDepositInformation.Date = CAST(CAST(GETDATE() AS date) AS datetime)");
            where.Append(" AND ChequeDepositInformation.IsDeleted = 0");
        ...
        public async Task<(IEnumerable<ChequeDepositListResponseDTO> Data, int TotalCount)> GetUnAuthorizedListAsync(
          ChequeDepositListRequestDTO request,
          long userId,
          string branchOrHub,
          string? hubIds,
          ...
          CancellationToken cancellationToken = default)
        {
            ...
            where.Append(" AND ChequeDepositInformation.status IN ('U')");
            where.Append(" AND ChequeDepositInformation.Date = CAST(CAST(GETDATE() AS date) AS datetime)");
            where.Append(" AND ChequeDepositInformation.IsDeleted = 0");
        ...
        public async Task<(IEnumerable<ChequeDepositListResponseDTO> Data, int TotalCount)> GetRejectListAsync(
          ChequeDepositListRequestDTO request,
          long userId,
          string branchOrHub,
          string? hubIds,
          ...
          CancellationToken cancellationToken = default)
        {
            ...
            where.Append(" AND ChequeDepositInformation.status IN ('RE')");
            where.Append(" AND ChequeDepositInformation.Date = CAST(CAST(GETDATE() AS date) AS datetime)");
            where.Append(" AND ChequeDepositInformation.IsDeleted = 0");
        ...
        public async Task<(IEnumerable<ChequeDepositListResponseDTO> Data, int TotalCount)> GetInProcessListAsync(
          ChequeDepositListRequestDTO request,
          long userId,
          string branchOrHub,
          string? hubIds,
          ...
          CancellationToken cancellationToken = default)
        {
            ...
            where.Append(" AND ChequeDepositInformation.status IN ('IP')");
            where.Append(" AND ChequeDepositInformation.Date = CAST(CAST(GETDATE() AS date) AS datetime)");
            where.Append(" AND ChequeDepositInformation.IsDeleted = 0");
        ...
        public async Task<ChequeDeposit?> GetByIdAsync(long id)
        {
            var entity = await _context.chequedepositInformation
                .AsNoTracking()
                .FirstOrDefaultAsync(x => x.Id == id);
            
            if (entity == null) return null;

            return new ChequeDeposit
            {
                Id = entity.Id,
                Date = entity.Date,
                Status = entity.status ?? string.Empty,
                SequenceNumber = entity.SequenceNumber ?? string.Empty,
                AccountNumber = entity.AccountNumber ?? string.Empty,
                ChequeNumber = entity.ChequeNumber ?? string.Empty,
                InstrumentNo = entity.InstrumentNo ?? string.Empty,
                AccountBalance = entity.AccountBalance ?? string.Empty,
                AccountTitle = entity.AccountTitle ?? string.Empty,
                Amount = entity.Amount ?? 0,
                PoStatus = entity.poStatus ?? string.Empty
            };
        }
    }
}